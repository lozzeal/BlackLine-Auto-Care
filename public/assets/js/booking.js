/* ============================================================
   BlackLine Auto Care — booking form
   Валідація, стиснення фото у браузері, відправка на /api/booking.
   Фото стискаються ще до відправки, щоб уміститись у ліміт
   тіла запиту Vercel (4.5 МБ) і не мучити мобільний інтернет.
   ============================================================ */
(function () {
  'use strict';
