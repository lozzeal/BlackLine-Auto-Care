...
| | Було | Стало |
|---|---|---|
| Тривалість | 7.92 с | 13.63 с |
| Пауза на краю | немає | 1.00 с |
| Швидкість у розвороті | 1.21 | 0.00 |
| Найрізкіша зміна швидкості | 0.42 | 0.47 (розподілена) |
| Стик циклу | 0.34 | 0.05 |
| MP4 / WebM | 574 / 372 KB | 788 / 466 KB |
